...
const Footer = () => {
  ...
  return (
    ...
    <div className=' bg-blue-950 mt-20 text-white py-3 px-6'>
    ...
    <div class='grid grid-cols-1   md:grid-cols-2 lg:grid-cols-4 gap-10 ' >
        ...
        <h1 class='mt-5'><Link to='/'> South Americ</Link></h1>
        <h1><Link to='/'>Paris</Link></h1>
        <h1><Link to='/'>Goa</Link></h1>
        <h1><Link to='/'>New York</Link></h1>
         <h1><Link to='/'>France</Link></h1>
          <h1><Link to='/'>Austrlia</Link></h1>
    ...
    <div>
     ...
     <h1><Link to='/'>policies & Guides</Link></h1>
       <h1><Link to='/'>Tracking My Booking</Link></h1>
    ...
    <div>
        ...
        <h1 className='card'>
<div class=  "flex ">
  <Link to="#" class="socialContainer containerOne">
  ...
  <Link to="#" class="socialContainer containerTwo">
  ...
  <Link to="#" class="socialContainer containerThree">
    <svg class="socialSvg linkdinSvg" viewBox="0 0 448 512"><path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path></svg>
  </Link>
  
  <Link to="#" class="socialContainer containerFour">
