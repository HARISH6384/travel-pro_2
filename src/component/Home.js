  ...
  return (
    ...
    <div className='back'>
        ...
        <p  class='text-base text-justify px-4 md:px-0  text-white font-bold  '>Discover a world of adventure with Compass. We transform travel from a simple trip into an unforgettable experience. Our expertly crafted tours and personalized itineraries unlock the most breathtaking destinations across the globe. </p>
         ...
         <img src={photo4}  class='w-[300px] sm:object-cover sm:w-[370px] h-[490px] sm:h-[580px]   '/>  
          
          <img src={photo5} class='w-[300px] sm:w-[350px] h-96 sm:h-[250px] '/>
          <img src={photo6} class='w-[300px] sm:w-[350px] h-96 sm:h-[250px] '/>
          <img src={photo8}  class='w-[300px] sm:w-[370px] h-[490px] sm:h-[370px ] '/>
        ...
        <div class=' relative  flex justify-center items-center gap-4'>  
          ...
          <img src={photo7} class='w-[300px] rounded-2xl   h-auto sm:w-[705px] sm:h-[270px] object-cover relative  md:bottom-[280px] left-1 sm:right-4'/>
        </div>
        ...
        <div class='flex  flex-wrap  gap-3 justify-center px-3 mt-6 '>
         ...
         {/* <div className='slider '>
          ...
          <div class='md:w-full    me-10 mt-10 text-blue-700 font-bold mx-20 space-y-10'>
            ...
            <h1 class=' text-base sm:text-xl flex px-2 py-1'><span><img className='w-10 pr-2 h-8' src={photo26}/></span>Find Your Destination</h1>
            ...
            <div class='border rounded-2xl py-5 w-72 bg-yellow-50 md:w-96 '>
              <h1 class=' text-base  py-1 sm:text-xl flex px-2'> <span><img className='w-10 pr-2 h-8' src={photo27}/></span>Book a Ticket</h1>
            ...
            <div class='border rounded-2xl w-72 py-8 bg-yellow-50  md:w-96 '>
              <h1 class=' text-base  sm:text-xl flex px-2'><span><img className='w-10 pr-2 h-8' src={photo28}/></span>Make Payment</h1>
              ...
              <div class='border rounded-2xl py-3 w-72 bg-yellow-50 md:w-96 '>
                <h1 class=' text-base py-1 sm:text-xl flex px-2'><sapn><img className='w-10 pr-2 h-8' src={photo29}/> </sapn>Explore Destination</h1>
              ...
              <div className='mt-10   px-28'>
               <img class='w-[400px]  h-[600px]'  src={photo30}/>
               </div>
